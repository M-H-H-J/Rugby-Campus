...
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.berkeley.edu','https://images.unsplash.com/photo-1671709141384-446544c292ca?w=800&q=80','mens')
...
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.usna.edu','https://images.unsplash.com/photo-1534724364725-325f10a8e182?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.life.edu','https://images.unsplash.com/photo-1707907778021-2a9d99531fcf?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.lindenwood.edu','https://images.unsplash.com/photo-1612032091753-ef76e271c2f7?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.stmarys-ca.edu','https://images.unsplash.com/photo-1685557869056-4e34c0a6368f?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.westpoint.edu','https://images.unsplash.com/photo-1588109506057-f460d4d96efd?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.ucla.edu','https://images.unsplash.com/photo-1729536234047-707a083aaeba?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.brown.edu','https://images.unsplash.com/photo-1641160507858-5c23bd287ce2?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.msmary.edu','https://images.unsplash.com/photo-1513125304595-23907ea1f332?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.byu.edu','https://images.unsplash.com/photo-1585156569731-4c5b959234f7?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.arizona.edu','https://images.unsplash.com/photo-1770489436142-20718aec012e?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.psu.edu','https://images.unsplash.com/photo-1665940482676-c0cb91965634?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.dartmouth.edu','https://images.unsplash.com/photo-1571113390215-0cdbbd0d0134?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.calpoly.edu','https://images.unsplash.com/photo-1626298319597-f63b57147598?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.sbu.edu','https://images.unsplash.com/photo-1659627807038-c3b4d6c89514?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
...
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.gcu.edu','https://images.unsplash.com/photo-1589046207215-b5ee3097bafc?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.umw.edu','https://images.unsplash.com/photo-1600172454300-f2ef8c3ea70a?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.queens.edu','https://images.unsplash.com/photo-1562762394-3acfba62a48e?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.nd.edu','https://images.unsplash.com/photo-1590327272286-120057714e11?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.osu.edu','https://images.unsplash.com/photo-1654115480560-67642e776a30?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.davenport.edu','https://images.unsplash.com/photo-1621972071408-83635a8dfd47?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.marian.edu','https://images.unsplash.com/photo-1593096966468-c7869f66def9?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.umich.edu','https://images.unsplash.com/photo-1606942746713-c4fb3779b82e?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.indiana.edu','https://images.unsplash.com/photo-1603707579489-3510cfcf1efd?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.stthomas.edu','https://images.unsplash.com/photo-1590791057266-cb564e6cf9dc?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://wheeling.edu','https://images.unsplash.com/photo-1636997048630-f41725823496?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.snu.edu','https://images.unsplash.com/photo-1594480355356-8b9833059231?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
...
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.scu.edu','https://images.unsplash.com/photo-1588917917061-565469424de9?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '[]','[]',
  'https://www.sandiego.edu','https://images.unsplash.com/photo-1650225554926-b70324a698ae?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '[]','[]',
  'https://www.utah.edu','https://images.unsplash.com/photo-1542385151-efd9000785a0?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.walsh.edu','https://images.unsplash.com/photo-1671656203501-72ec84f3d892?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'Warm summers, cold snowy winters.','[{"month": "Jan", "hF": 32, "lF": 17, "hC": 0, "lC": -8}, {"month": "Feb", "hF": 35, "lF": 19, "hC": 2, "lC": -7}, {"month": "Mar", "hF": 44, "lF": 27, "hC": 7, "lC": -3}, {"month": "Apr", "hF": 57, "lF": 37, "hC": 14, "lC": 3}, {"month": "May", "hF": 69, "lF": 47, "hC": 21, "lC": 8}, {"month": "Jun", "hF": 77, "lF": 57, "hC": 25, "lC": 14}, {"month": "Jul", "hF": 80, "lF": 61, "hC": 27, "lC": 16}, {"month": "Aug", "hF": 78, "lF": 59, "hC": 26, "lC": 15}, {"month": "Sep", "hF": 71, "lF": 52, "hC": 22, "lC": 11}, {"month": "Oct", "hF": 60, "lF": 41, "hC": 16, "lC": 5}, {"month": "Nov", "hF": 47, "lF": 32, "hC": 8, "lC": 0}, {"month": "Dec", "hF": 36, "lF": 23, "hC": 2, "lC": -5}]',
  '[]','[]',
  'https://www.siena.edu','https://images.unsplash.com/photo-1589038026354-0033d7f8a76e?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '["7 MLR Draft Picks"]','[]',
  'https://www.kutztown.edu','https://images.unsplash.com/photo-1724412643952-f31cd14e3611?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '[]','[]',
  'https://www.belmontabbeycollege.edu','https://images.unsplash.com/photo-1650504800364-efe2db480bab?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '["3 MLR Draft Picks"]','[]',
  'https://www.thomasmore.edu','https://images.unsplash.com/photo-1787094405944-f79d01f1d674?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '["2 MLR Draft Picks"]','[]',
  'https://www.iona.edu','https://images.unsplash.com/photo-1657183200185-55d35726f8cf?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  '[]','[]',
  'https://www.fairfield.edu','https://images.unsplash.com/photo-1696021785168-cd9c3537be46?w=800&q=80','mens')
on conflict (slug) do nothing;
insert into colleges (slug,name,location,state,region,lat,lng,map_x,map_y,affiliation,conference,tier,program_type,draft_picks,player_count,coach_name,coach_email,description,enrollment,popular_majors,weather_summary,monthly_temps,badges,achievements,website,image_url,gender) values (
  ...
  'https://www.wwu.edu','https://images.unsplash.com/photo-1600571776717-386df4d0a882?w=800&q=80','mens')
on conflict (slug) do nothing;
