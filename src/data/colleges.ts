...
export const colleges: College[] = [
  ...
  },
  {
    ...
    affiliation: "Both", conference: "Independent", tier: "playoff", programType: "Club",
    draftPicks: 4, playerCount: 54,
    coachName: "Harry Bennett", coachEmail: "hbennett@recreation.ucla.edu",
    description: "UCLA competes in both CRAA D1A and NCR D1 for 2026–27, playing the spring D1A championship and the fall NCR season. The Bruins play on one of the best rugby fields in the country at Wallis Annenberg Stadium, with live scoreboards and video replay, and have produced four MLR draft picks.",
